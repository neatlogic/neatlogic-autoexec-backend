    ...
    for appname in appnames:
        ...
        if appfile.endswith('.war'):
            ...
            if os.path.exists(targetdir) and os.path.exists(desctarget):
                ...
                # remove the WEB-INF/lib
                cleanCmd = 'rm -rf %s/WEB-INF/lib/*' % targetdir
                print('INFO: Remove lib jar in %s/WEB-INF/lib/*.\n' % targetdir)
                os.system(cleanCmd)
        ...
        # TODO: ear extract must to be tested.
            ...
            if os.path.exists(targetdir) and os.path.exists(desctarget):
                ...
                cleanCmd = 'rm -rf %s/*.war/WEB-INF/lib/*' % targetdir
                print('INFO: Remove lib jar in WEB-INF %s/*.war/WEB-INF/lib/*.\n' % targetdir)
                os.system(cleanCmd)
