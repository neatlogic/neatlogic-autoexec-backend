...
if insname is not None:
        ...
        print("ERROR:use as was-cluster-stop.py config-name instance-name\n")
        sys.exit(1)
...
cmd = '%s/bin/wsadmin.sh  -lang jython -user %s -password %s -f %s/bin/was-cluster-poststop.py' % (wasprofile,was_user,was_pwd,homepath)
