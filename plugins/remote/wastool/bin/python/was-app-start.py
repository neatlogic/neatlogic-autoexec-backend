...
if insname is not None:
	...
	print("ERROR:use as was-app-start.py config-name instance-name\n")
	sys.exit(1)
...
cmd = '%s/bin/wsadmin.sh  -lang jython -user %s -password %s -f %s/bin/was-app-poststart.py' % (wasprofile,was_user,was_pwd,homepath)
