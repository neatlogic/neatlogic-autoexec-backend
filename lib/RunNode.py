...
class RunNode:
    ...
    def _localExecute(self, op):
        ...
        environment["AUTOEXEC_GROUP_NO"] = str(self.groupNo)
                    ...
                    if not hasError:
                        for name in files:
                            ...
                            try:
                                ...
                                sftp.chmod(name, stat.S_IMODE(os.stat(absFilePath).st_mode))
                            except Exception as err:
                                hasError = True
                    ...
                    try:
                        for file in os.listdir(os.path.join(self.context.runPath, "file")):
                            ...
                            if os.path.isfile(localFilePath):
                                ...
                                # sftp.chmod(name, stat.S_IMODE(os.stat(localFilePath).st_mode))
                    except Exception as err:
                        hasError = True
