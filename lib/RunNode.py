...
class RunNode:
    ...
    def execute(self, ops):
        ...
        try:
            ...
            self.writeNodeLog("======Node {}:{}[{}] Launched with {}@{}:{}======\n".format(self.host, self.port, self.id, self.username, self.host, self.protocolPort))
            ...
            self.writeNodeLog("======{}:{}[{}] Ended, duration:{:.2f} second ======\n".format(self.host, self.port, self.id, nodeConsumeTime))
