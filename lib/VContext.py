...
class VContext:
    def __init__(self, jobId=0, execId=0, execUser=None, isForce=False, devMode=False, dataPath=None, runPath=None, noFireNext=False, passThroughEnv={}):
        ...
        self.rexecExecTimeout = int(config["autoexec"].get("rexec.execTimeout", 86400))
