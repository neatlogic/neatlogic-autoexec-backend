...
class PhaseStatus:
    def __init__(self, phaseName):
        ...
        self.roundAllFinEvent = threading.Event()
    ...
    def setAllRunnerFinEvent(self):
        self.roundAllFinEvent.set()

    def clearAllRunnerFinEvent(self):
        self.roundAllFinEvent.clear()

    def waitAllRunnerFin(self, timeOut=86400):
        return self.roundAllFinEvent.wait(timeout=timeOut)
